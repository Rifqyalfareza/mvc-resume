...
class PartCustomer{
    ...
    public function all(){
        $stmt = $this->db->query("SELECT *, part.part_name as part, customer.singkatan as customer,customer.nama_customer as customer_name, model.nama_model as model 
    ...
    public function find($id){
        $stmt = $this->db->query("SELECT *, part.part_name as part, customer.singkatan as customer,customer.nama_customer, model.nama_model as model 
                                    FROM part_customer JOIN customer ON part_customer.id_customer = customer.id_customer
                                    JOIN part ON part_customer.id_part = part.id_part
