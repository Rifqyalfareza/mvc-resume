<div class="pb-8">
    <form action="?page=resume&action=store" method="post">
        <div class="flex items-center justify-between mb-8 px-8 pt-8 border-b border-gray-200 pb-5">
            <h1 class="text-2xl font-bold text-gray-600 dark:text-white">Input Resume</h1>
        ...
        <div class="px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                    ...
                    <div class="relative">
                        <label for="datepicker-autohide" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal <span class="text-red-500">*</span></label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="qty_ng" id="qty_ng"
                                class="ps-10 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white p-2.5 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                        </div>
                    </div>
                </div>
