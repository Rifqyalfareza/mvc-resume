<div class="pb-8">
    <div class="flex items-center justify-between mb-8 px-8 pt-8">
        <h2 class="text-gray-600 text-2xl font-bold ">Part Customer</h2>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Part Customer</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <tbody>
                ...
                <?php foreach ($partCustomers as $partCustomer) : ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><a href="#"><?= $no++; ?></a></td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $partCustomer['customer'] ?></td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $partCustomer['part'] ?></td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $partCustomer['model'] ?></td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $partCustomer['part_number'] ?></td>
                        ...
                        <td class="flex gap-2 text-center justify-center">
                                <a href="?page=resume&action=create&id=<?= $partCustomer['id_part_cust'] ?>"
                                    ...
                                    class="bg-yellow-300 hover:bg-yellow-500 p-1">
